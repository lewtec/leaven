...
import (
	...
	asmenum "github.com/lewtec/leaven/internal/llir/v14/asm/enum"
	...
	"github.com/lewtec/leaven/internal/llir/ir/metadata"
...
func (gen *generator) irFuncAttribute(old ast.FuncAttribute) ir.FuncAttribute {
	...
	case *ast.AttrGroupID:
		...
		if !ok {
			...
			//
			// This issue is tracked at: https://github.com/lewtec/leaven/internal/llir/v14/llvm/issues/37
